...
export default function UserLogin() {
  ...
  return (
    <div className="min-h-screen relative bg-gradient-to-br from-white via-orange-50 to-white flex items-center justify-center p-4">
        ...
        <div className="bg-white rounded-3xl p-8 shadow-2xl border border-slate-200">
          ...
          {mode === "login" ? (
            ...
            <div className="space-y-4">
                ...
                <div className="flex items-center justify-between mb-2">
                  <div>
                    ...
                    <p className="text-xs text-slate-400 mt-0.5">
                      Create your account to begin your personalized setup.
                    </p>
                  </div>
                  <span className="text-xs font-semibold text-orange-500">Step 1</span>
                </div>
              </div>
              ...
              <label className="flex items-start gap-2 text-slate-500 text-sm cursor-pointer pt-1">
                <input
                  type="checkbox"
      ...
      {/* =========================================================== */}
      {/* FULL TRAINER PROFILE MODAL — SIGNUP */}
      {/* =========================================================== */}
    </div>
  );
}
