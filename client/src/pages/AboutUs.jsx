    ...
    <div className="min-h-screen bg-[#fffaf5] dark:bg-[#080808] text-slate-900 dark:text-white pb-24">
      ...
      <div className="px-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl p-5">
          <h2 className="font-bold text-slate-900 mb-3">About the Gym</h2>
        ...
        <div className="bg-white rounded-2xl p-5 space-y-4">
          <h2 className="font-bold text-slate-900 mb-1">Gym Information</h2>
          {[
            ...
            <div key={item.label} className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-slate-900 whitespace-pre-line">{item.value}</p>
              </div>
            </div>
          ))}
        </div>
        ...
        {/* Services */}
        <div className="bg-white rounded-2xl p-5">
          <h2 className="font-bold text-slate-900 mb-3">Our Services</h2>
        ...
        {/* Feedback Form */}
        <div className="bg-white rounded-2xl p-5">
          <h2 className="font-bold text-slate-900 mb-1">Send Feedback</h2>
          <p className="text-slate-500 text-xs mb-4">We'd love to hear from you!</p>
          ...
          <div className="space-y-3 mb-4">
            <div>
              ...
              <input type="text" value={feedback.name}
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500" />
            </div>
            <div>
            ...
            <div>
              ...
              <textarea rows={4} value={feedback.message}
                ...
                className="w-full bg-slate-50 border border-slate-200 rounded-xl px-4 py-2.5 text-slate-900 text-sm focus:outline-none focus:ring-2 focus:ring-orange-500 resize-none" />
            </div>
          </div>
          ...
          <button onClick={handleSubmit}
            ...
            className="w-full bg-orange-500 hover:bg-orange-600 disabled:opacity-40 text-white font-bold py-3 rounded-xl transition text-sm">
            Submit Feedback
          </button>
        </div>
